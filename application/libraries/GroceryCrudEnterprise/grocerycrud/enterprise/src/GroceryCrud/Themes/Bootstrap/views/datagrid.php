<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.12.e407eae.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.12.e407eae' . $minify_or_not . '.js');
